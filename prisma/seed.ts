    ...
    data: {
      ...
      exercises: {
        create: [
          ...
          { order: 4, name: "Back Squat", sets: "4", reps: "5", weight: "100kg", load: "70%", tempo: "31X1", rest: "2:30", notes: "Leave one rep in the tank on the top set." },
          { order: 5, name: "Romanian Deadlift", sets: "3", reps: "8", weight: "80kg", load: "RPE 7", rest: "2:00" },
    ...
    data: {
      ...
      exercises: {
        create: [
          ...
          { order: 3, name: "Back Squat", sets: "4", reps: "5", weight: "100kg", load: "70%", tempo: "31X1", rest: "2:30" },
          { order: 4, name: "Romanian Deadlift", sets: "3", reps: "8", weight: "80kg", load: "RPE 7", rest: "2:00" },
